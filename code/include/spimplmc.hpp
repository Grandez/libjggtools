/*
*   Smart Pointer to IMPL Copyable and moveable
    ====================================================================
...
#ifndef __SPIMPLMC_HPP__
#define __SPIMPLMC_HPP__
...
namespace spimpl  {
    ...
    inline unique_impl_ptr<T> make_unique_impl(Arguments&&... args)
    {
        return unique_impl_ptr<T>(new T(std::forward<Arguments>(args)...), &details::default_delete<T>);
    }
    ...
    template<class T, class... Arguments>
    inline impl_ptr<T> make_impl(Arguments&&... args)
    {
        return impl_ptr<T>(new T(std::forward<Arguments>(args)...), &details::default_delete<T>, &details::default_copy<T>);
    }
