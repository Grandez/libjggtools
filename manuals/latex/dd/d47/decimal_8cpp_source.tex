...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00014}00014    Decimal::Decimal(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* value)  \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00017}00017         \textcolor{keywordflow}{if} (!match) \textcolor{keywordflow}{throw} \textcolor{keyword}{new} ToolsValueException(BAD\_DECIMAL, value);}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00018}00018         vector<char *> data = (sstring(value)).tokenize(\textcolor{stringliteral}{"{}[\(\backslash\)\(\backslash\).,]"{}});}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00019}00019         \textcolor{keywordflow}{if} (data.size() > 2 || data.size() == 0) \textcolor{keywordflow}{throw} \textcolor{keyword}{new} ToolsValueException(BAD\_DECIMAL, value);}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00030}00030    Decimal::Decimal(\textcolor{keywordtype}{float}       value) \{ }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00034}00034    Decimal::Decimal(\textcolor{keywordtype}{double}      value) \{ }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00038}00038    Decimal::Decimal(\textcolor{keywordtype}{long} \textcolor{keywordtype}{double} value) \{ }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00042}00042    Decimal::Decimal(\textcolor{keywordtype}{int} value)         \{ }
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00043}00043 this-\/>number = value;            \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00044}00044    Decimal::Decimal(\textcolor{keywordtype}{long} value)        \{ }
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00045}00045 this-\/>number = value;            \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00046}00046    Decimal::Decimal(\textcolor{keywordtype}{long} \textcolor{keywordtype}{long} value)   \{ }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00053}00053    sstring Decimal::toString() \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00064}00064    \textcolor{keywordtype}{char}* Decimal::toChar() \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00067}00067    sstring  Decimal::toStringRounded(\textcolor{keywordtype}{int} scale) \{}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00068}00068        Decimal dec = round(scale);}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00069}00069        \textcolor{keywordflow}{return} dec.toString();}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00070}00070    \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00071}00071    \textcolor{keywordtype}{char}* Decimal::toCharRounded(\textcolor{keywordtype}{int} scale) \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00074}00074    \textcolor{keywordtype}{float} Decimal::toFloat() \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00078}00078    \textcolor{keywordtype}{double}  Decimal::toDouble() \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00082}00082    \textcolor{keywordtype}{long} \textcolor{keywordtype}{double} Decimal::toLongDouble() \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00086}00086    \textcolor{keywordtype}{long} Decimal::toFloor() \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00090}00090    \textcolor{keywordtype}{long} Decimal::toCeil() \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00093}00093    Decimal Decimal::round(\textcolor{keywordtype}{int} scale) \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00100}00100        \textcolor{keywordflow}{return} Decimal(value / p2, scale);}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00101}00101    \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00102}00102    Decimal Decimal::operator+  (\textcolor{keyword}{const} Decimal\& b) \{ \textcolor{keywordflow}{return} add(*\textcolor{keyword}{this}, b); \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00103}00103    Decimal Decimal::operator+= (\textcolor{keyword}{const} Decimal\& b) \{}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00104}00104       Decimal res = add(*\textcolor{keyword}{this}, b); }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00109}00109    Decimal Decimal::operator-\/  (\textcolor{keyword}{const} Decimal\& b) \{ \textcolor{keywordflow}{return} subtract(*\textcolor{keyword}{this}, b); \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00110}00110    Decimal Decimal::operator-\/= (\textcolor{keyword}{const} Decimal\& b) \{}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00111}00111       Decimal res = add(*\textcolor{keyword}{this}, b); }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00116}00116    Decimal Decimal::operator*  (\textcolor{keyword}{const} Decimal\& b) \{ \textcolor{keywordflow}{return} multiply(*\textcolor{keyword}{this}, b); \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00117}00117    Decimal Decimal::operator*= (\textcolor{keyword}{const} Decimal\& b) \{}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00118}00118       Decimal res  = multiply(*\textcolor{keyword}{this}, b); }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00123}00123    Decimal Decimal::operator/  (\textcolor{keyword}{const} Decimal\& b) \{ \textcolor{keywordflow}{return} divide(*\textcolor{keyword}{this}, b); \}}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00124}00124    Decimal Decimal::operator/= (\textcolor{keyword}{const} Decimal\& b) \{}
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00125}00125       Decimal res  = divide(*\textcolor{keyword}{this}, b); }
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00130}00130    \textcolor{keywordtype}{bool} Decimal::operator==(\textcolor{keyword}{const} Decimal\& b) \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00135}00135    \textcolor{keywordtype}{bool} Decimal::operator!=(\textcolor{keyword}{const} Decimal\& b) \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00140}00140    \textcolor{keywordtype}{bool} Decimal::operator<(\textcolor{keyword}{const} Decimal\& b) \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00145}00145    \textcolor{keywordtype}{bool} Decimal::operator<=(\textcolor{keyword}{const} Decimal\& b) \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00150}00150   \textcolor{keywordtype}{bool} Decimal::operator>(\textcolor{keyword}{const} Decimal\& b) \{}
...
\DoxyCodeLine{\Hypertarget{decimal_8cpp_source_l00155}00155   \textcolor{keywordtype}{bool} Decimal::operator>=(\textcolor{keyword}{const} Decimal\& b) \{}
